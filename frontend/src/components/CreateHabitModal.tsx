                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            <div className="mb-6 flex items-center justify-between">
                                <h2 className="font-['Space_Grotesk'] text-2xl font-bold text-slate-900">Create New Habit</h2>
                                <motion.button
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div>
                                    <label className="mb-2 block text-sm font-semibold text-slate-700" htmlFor="frequency">
                                        Frequency
                                    </label>
                                    <select
